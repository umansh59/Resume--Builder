  ...
  {formData.certifications.map((certification, index) => (
    <div key={index} className="certifications-entry">
      <input
        ...
        onChange={(e) =>
          handleItemChange('certifications', index, { ...certification, course: e.target.value })
        }
      />
      <input
        type="text"
        ...
        onChange={(e) =>
          handleItemChange('certifications', index, { ...certification, institute: e.target.value })
        }
      />
    </div>
  ))}
...
{/* ... (Rest of the code remains the same) */}
        ...
        {/* ... (Repeat the above pattern for other dynamic fields like education, skills, certifications, projects) */}
